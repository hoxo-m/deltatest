...
To address this issue, Deng et al. (2018) proposed a statistical hypothesis testing method. It replaces the standard variance estimation formula in the Z-test with an approximate formula using the Delta method which can account for within-user correlation. This package has been developed to make it easy to execute that method.
