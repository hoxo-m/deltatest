...
```{r p-values-from-z-test, echo=FALSE, fig.alt="p-values from standard Z-test on correlated data"}
library(dplyr)
library(ggplot2)
...
```{r p-values-from-delta-method, echo=FALSE, fig.alt="p-values from Z-test with Delta method on correlated data"}
