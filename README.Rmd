...
By default, `deltatest` tests the difference between two groups. If you specify `'relative_change'` for this argument, it tests the rate of change: $(\mu_{t} - \mu_{c}) / \mu_{c}$ where $\mu_c$ and $\mu_t$ represent the mean values of the control group and the treatment group, respectively.
