...
The **deltatest** package provides
[`deltatest()`](https://hoxo-m.github.io/deltatest/reference/deltatest.md),
a function for performing two-sample Z-tests using the delta method.
...
[`deltatest()`](https://hoxo-m.github.io/deltatest/reference/deltatest.md)
addresses this issue by using a delta-method-based variance estimator.
...
![p-values from standard Z-test on correlated
data](reference/figures/README-p-values-from-z-test-1.png)
...
![p-values from Z-test with Delta method on correlated
data](reference/figures/README-p-values-from-delta-method-1.png)
...
[`help(deltatest)`](https://hoxo-m.github.io/deltatest/reference/deltatest.md).
